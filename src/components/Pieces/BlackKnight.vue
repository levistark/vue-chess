<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" ref="element" @mousedown="handleClick">
    <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill="#fff" stroke="#fff" stroke-width="1.49997"/>
